...
export MIN_CHALLENGE_PBR_MATERIALS="6"
export MIN_CHALLENGE_PHYSICS_PROXY_COUNT="22"
export MIN_CHALLENGE_PHYSICS_PROXY_CONTACT_STEPS="3"
export MIN_CHALLENGE_MATERIAL_CONTACT_STEPS="20"
export MIN_CHALLENGE_GRASS_DEFORMED_BLADES="120"
export MIN_CHALLENGE_GRASS_FRESH_AFFECTED_BLADES="12"
